...
Visit the website: [RMS](https://google.com/)
...
To run Spring Boot application on your local machine:

- Clone the project
```    
https://github.com/dimilidi/
  ```

you have to execute the main method in the RestaurantManagementSystemApplication class from your IDE.
