package Homeworks_And_Labs.L02_Java_OOP_Encapsulation_LAB.ValidationData;
...
public class Person {
   ...
   public int getAge() {
    ...
    public void increaseSalary(double bonus) {
        ...
        if (this.age >= 30) {
            actualSalary = this.salary + this.salary * bonus / 100;
        } else {
            actualSalary = this.salary + this.salary * (0.5 * bonus) / 100;
        }
